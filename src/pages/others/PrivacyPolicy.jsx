        ...
        <div className="max-w-4xl mx-auto p-6 shadow-md rounded-lg mt-6">
            ...
            <section className="mb-6">
                ...
                <ul className="list-disc pl-5 mb-4  ">
                    ...
                    <li>Phone number</li>
                    <li>
                        Payment details (e.g., credit card information, billing
                        address)
                    </li>
                    <li>Identification details (e.g., government-issued ID)</li>
                </ul>
            ...
            <section className="mb-6">
                ...
                <ul className="list-disc pl-5 mb-4  ">
                    ...
                    <li>
                        <strong>To improve our Platform:</strong> To understand
                        how users interact with our Platform and improve our
                        services.
                    </li>
                    <li>
                        <strong>To communicate with you:</strong> To send you
                        booking confirmations, important updates, and
                        promotional materials (if you’ve opted in).
                    </li>
                    <li>
                        <strong>To process payments:</strong> To facilitate
                        transactions and ensure secure payments.
                    </li>
                    <li>
                        <strong>For legal compliance:</strong> To comply with
                        legal obligations, enforce our terms, and protect
                        against fraud or security risks.
                    </li>
                </ul>
            </section>
